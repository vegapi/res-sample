...
//      },
    ...
    server.use(todo.loadTodos);

    server.post('/todo', todo.createTodo);
    server.get('/todo', todo.listTodos);
    server.head('/todo', todo.listTodos);


    // everything else requires that the TODO exist
    server.use(todo.ensureTodo);

    // Return a TODO by name

    server.get('/todo/:name', todo.getTodo);
    server.head('/todo/:name', todo.getTodo);
    ...
    server.del('/todo/:name', todo.deleteTodo);
